...
const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <div className="bg-blue-500 dark:bg-blue-900 text-white  p-4 flex items-center justify-between shadow-md relative" onClick={handleOverlayClick}>
      ...
      {openSettings && (
        <div className="absolute flex flex-col border p-2 space-y-3 z-50 top-9 bg-gray-50 dark:bg-gray-800 border-gray-50 dark:border-gray-700 text-gray-500 dark:text-gray-300 right-8 rounded-md">
          <button className=" hover:bg-gray-100 dark:hover:bg-gray-600 flex space-x-2 p-2 items-center" onClick={() => setShowInfoModal(true)}>
          ...
          <button onClick={handleLeaveGroup} className=" p-2 hover:bg-gray-100 dark:hover:bg-gray-600 flex space-x-2 items-center">
